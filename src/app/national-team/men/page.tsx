...
import data from "../../../data/national-team-men.json";
...
export default function MenTeamPage() {
  ...
  return (
    <main>
      <section className="projects" id="national-team-men">
        <div className="container">
          <h2>Men's Tibetan National Team</h2>
          <div
            style={{
              display: "grid",
